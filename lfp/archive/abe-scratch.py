    ...
    for filename in glob.glob(search_path):
        ...
        try:
            with h5py.File(filename, "r") as f:
                    ...
                    locations = locations[:,:,:,:]
            sleapfiles[file] = [locations.shape[0], tracks]
        except OSError:
             print(file)
    return(sleapfiles)


#phase2_sleap = r"D:\social_ephys_pilot2_cum\sleap\phase2\pose_estimation\h5_files"
#phase2_sleap_dict = get_frame_num(phase2_sleap)    
#phase2_sleap_dict        
...
input_dir = r"D:\social_ephys_pilot2_cum\data\phase2\20230803_121318_1.4_3t3bL_NFC.rec"
output_path = r"D:\social_ephys_pilot2_cum\data\phase2\20230803_121318_1.4_3t3bL_NFC.rec\outputs"
...
# %%
metadata_df = unpickle_this(os.path.join(output_path, "metadata.pkl"))
metadata_df
...
# %%
pickle_this(lfp_granger_df, r"D:\social_ephys_pilot2_cum\data\phase2\20230803_101331_1.1_1t1bL_FCN.rec\outputs\lfp_all_df.pkl")
