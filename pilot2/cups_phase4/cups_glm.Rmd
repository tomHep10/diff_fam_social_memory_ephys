...
# model1 <- lmer(value ~ (region_or_pair:band)  * agent +(region_or_pair:band) * color + (1|trial) + (1|location) + (1|X), power_df)
# model2 <- lmer(value ~ (region_or_pair:band)  * agent + (1|color) + (1|trial) + (1|location) + (1|X) + (1|event_length), power_df)
# model3 <- lmer(value ~ (region_or_pair:band)  * agent + (1|color) + (1|trial) + (1|location) + (1|X) + (1|event_length) + (1|Preference), power_df)
model6 <- lmer(value ~ (region_or_pair:band)  * agent + (agent|trial) + (agent|X) + (1|event_length) + (1|Preference), power_df)
# model7 <- lmer(value ~ (region_or_pair:band)  * agent + (1|trial) + (agent|X) + (1|event_length) + (1|Preference), power_df)
# model8 <- lmer(value ~ (region_or_pair:band)  * agent + (agent|trial) + (1|X) + (1|event_length) + (1|Preference), power_df)


```

```{r}
# model4 <- lmer(value ~ (region_or_pair:band)  * agent + (trial|X) + (agent|X) + (1|event_length) + (1|Preference), power_df)
# 
# model5 <- lmer(value ~ (region_or_pair:band)  * agent + (trial|agent) + (agent|X) + (1|event_length) + (1|Preference), power_df)

```

```{r}
anova(model1, model2, model3, model6, model7, model8)
...
power_contrasts <- emmeans(model6, ~ agent * (region_or_pair:band))
